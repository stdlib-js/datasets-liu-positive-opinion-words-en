...
```javascript
words = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-liu-positive-opinion-words-en@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-liu-positive-opinion-words-en@v0.2.0-umd/browser.js"></script>
```
